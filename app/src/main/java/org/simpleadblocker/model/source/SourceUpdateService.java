...
public final class SourceUpdateService {
    ...
    public static class HostsSourcesUpdateWorker extends Worker {
        ...
        public Result doWork() {
            ...
            // Create model
            SimpleAdBlockerApplication application = (SimpleAdBlockerApplication) getApplicationContext();
         ...
         */
        private void doUpdate(SimpleAdBlockerApplication application) throws HostErrorException {
